# Проект по Яндекс Лицею "Встречалки" (randoccasion)
...
```
cd existing_repo
git remote add origin https://gitlab.crja72.ru/django/2025/autumn/course/projects/team-8.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.crja72.ru/django/2025/autumn/course/projects/team-8/-/settings/integrations)
